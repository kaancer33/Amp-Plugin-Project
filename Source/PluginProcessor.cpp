...
void NewProjectAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    odBypassGain.setCurrentAndTarget     (0.0f);   // OD defaults to off
    delayBypassGain.setCurrentAndTarget  (1.0f);   // Delay defaults to on
    reverbBypassGain.setCurrentAndTarget (1.0f);   // Reverb defaults to on
